...
import * as utils from './datatypes/utils'

import * as conditionalDatatypes from './datatypes/compiler-conditional'
import * as structuresDatatypes from './datatypes/compiler-structures'
import * as utilsDatatypes from './datatypes/compiler-utils'
...
export class CompiledProtodef {
    ...
    constructor(sizeOfCtx: number, writeCtx: number, readCtx: number) {
        this.sizeOfCtx = sizeOfCtx
        this.writeCtx = writeCtx
        this.readCtx = readCtx
    }

    read(buffer: Buffer, cursor, type) {
    ...
    parsePacketBuffer(type, buffer: Buffer, offset = 0) {
