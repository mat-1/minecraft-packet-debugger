import { PartialReadError } from '../utils'
import numericSchema from '../schemas/numeric.json'
...
const types = Object.keys(nums).reduce((types, num) => {
    types[num] = generateFunctions(nums[num][0], nums[num][1], nums[num][2], numericSchema[num])
    return types
}, {})
types.i64 = [readI64, writeI64, 8, numericSchema.i64]
types.li64 = [readLI64, writeLI64, 8, numericSchema.li64]
types.u64 = [readU64, writeU64, 8, numericSchema.u64]
types.lu64 = [readLU64, writeLU64, 8, numericSchema.lu64]
